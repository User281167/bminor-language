...
class Symtab:
    ...
    refieren.
    Hay una tabla de símbolo separada para cada elemento de
    código que tiene su propio contexto (por ejemplo cada función,
    tendra su propia tabla de símbolo). Como resultado,
    las tablas de símbolo se pueden anidar si los elementos de
