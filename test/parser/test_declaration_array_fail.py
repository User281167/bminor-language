...
class TestArrayFailingCases(unittest.TestCase):
    ...
    def test_missing_square_brackets(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por falta de corchetes"
        )
    ...
    def test_missing_equals_sign(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por falta de signo '='"
        )
    ...
    def test_missing_curly_braces(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por falta de llaves"
        )
    ...
    def test_missing_semicolon(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por falta de punto y coma"
        )
    ...
    def test_array_with_missing_comma_separator(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por separador de coma faltante"
        )

    def test_array_with_trailing_comma(self):
        code = "a: array [2] integer = {1, 2,};"
        self.parse(code)
        self.assertNotEqual(errors_detected(), 0, "Se esperaba error por coma final")

    def test_array_with_extra_comma(self):
        code = "a: array [2] integer = {1, , 2};"
        self.parse(code)
        self.assertNotEqual(errors_detected(), 0, "Se esperaba error por coma extra")
