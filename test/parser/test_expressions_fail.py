...
class TestExpressionErrors(unittest.TestCase):
    ...
    def test_missing_operand(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por operando faltante"
        )
    ...
    def test_missing_operator(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por operador faltante"
        )
    ...
    def test_unmatched_parentheses(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por paréntesis no balanceados"
        )
    ...
    def test_missing_semicolon_in_expression(self):
        ...
        self.parse(code)
        self.assertNotEqual(
            errors_detected(), 0, "Se esperaba error por punto y coma faltante"
        )
