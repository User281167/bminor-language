...
class TestNumbers(unittest.TestCase):
    ...
    def test_valid_plus_integer(self):
        ...
        self.assertEqual(tokens[1].type, TokenType.INTEGER_LITERAL.value)
    ...
    def test_valid_float(self):
        ...
        tokens = list(self.lexer.tokenize(test_input))
        self.assertEqual(len(tokens), 1)
        self.assertEqual(tokens[0].type, TokenType.FLOAT_LITERAL.value)
    ...
    def test_valid_integer_and_float(self):
        ...
        expected = [
            (TokenType.FLOAT_LITERAL.value, 42.42),
            (TokenType.INTEGER_LITERAL.value, 5),
            (TokenType.FLOAT_LITERAL.value, 3.14),
            (TokenType.FLOAT_LITERAL.value, 0.42),
