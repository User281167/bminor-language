...
class TestArrayAndLoopTokens(unittest.TestCase):
    ...
    def test_array_declaration(self):
        ...
        expected_types = [
            TokenType.ID.value, LiteralType.COLON.value, TokenType.ARRAY.value,
            '[', TokenType.INTEGER_LITERAL.value, ']', TokenType.INTEGER.value, ';'
        ]
    ...
    def test_array_initialization(self):
        ...
        expected_types = [
            TokenType.ID.value, LiteralType.COLON.value, TokenType.ARRAY.value,
            '[', TokenType.INTEGER_LITERAL.value, ']', TokenType.INTEGER.value,
            '=', '{', TokenType.INTEGER_LITERAL.value, ',', TokenType.INTEGER_LITERAL.value,
            ',', TokenType.INTEGER_LITERAL.value, ',', TokenType.INTEGER_LITERAL.value,
    ...
    def test_unclosed_bracket(self):
        input_test = "array [5"
        tokens = list(self.lexer.tokenize(input_test))
        expected_types = [TokenType.ARRAY.value,
                          '[', TokenType.INTEGER_LITERAL.value]
        self.assertEqual([t.type for t in tokens], expected_types)
